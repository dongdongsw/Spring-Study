  	...
  	let detailApp=Vue.createApp({
  			...
  			methods:{
  				addScript(){
  					...
  					script.src="https://dapi.kakao.com/v2/maps/sdk.js?autoload=false&appkey=eceae8f48d6cfa28f55de551f70f135b&libraries=services"
	  				    ...
	  				    // 정상적으로 검색이 완료됐으면 
	  				     if (status === kakao.maps.services.Status.OK) {
	  				        ...
	  				        var infowindow = new kakao.maps.InfoWindow({
	  				            content: '<div style="width:150px;text-align:center;padding:6px 0;">'+$('#name').text() +'우리회사</div>'
	  				        });
